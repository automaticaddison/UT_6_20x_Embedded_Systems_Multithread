...
// as part of Lab 11 implement this function. Addison added code here
  unsigned long i = 0;
	// go from the beginning to the end of the character string
  while(buffer[i] != '\0'){
    UART_OutChar(buffer[i]); // write each character
...
// convert unsigned decimal into ascii characters
	if(n < 10) {
    String[0] = ' ';
    String[1] = ' ';
    String[2] = ' ';
    ...
    String[0] = ' ';
    String[1] = ' ';
    String[2] = (n / 10) % 10 + 0x30;
    String[3] = n % 10 + 0x30;
  } 
	else if(n < 1000) {
    String[0] = ' ';
    String[1] = (n / 100) % 10 + 0x30;
    String[2] = (n / 10) % 10 + 0x30;
    String[3] = n % 10 + 0x30;
  }
	else if(n < 10000) {
